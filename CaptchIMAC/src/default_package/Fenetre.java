...
public class Fenetre {
	...
	//getters
	public static ArrayList<URL> getSelectedImages() {
		return selectedImages;
	}
	
	//setters
public static void setSelectedImages(ArrayList<URL> selectedImages) {
	Fenetre.selectedImages = selectedImages;
}
	...
	public static JLabel createLabelImage(String imageLocation) throws IOException{
		...
		label.addMouseListener(new MouseListener() { //Ajouter le listener d'évenement de souris
			...
			@Override
			public void mouseClicked(MouseEvent arg0) { //ce qui nous interesse c'est lorsqu'on clique sur une image, il y a donc des choses à faire ici
